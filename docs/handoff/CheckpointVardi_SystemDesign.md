...
Checkpoint Varði is a web application for preparing, maintaining, and
producing the written safety plan that Icelandic law requires of every
workplace. It operationalises the statutory six-step risk assessment
methodology issued by Vinnueftirlitið (the Administration of
Occupational Safety and Health), digitises the forty-eight sectoral
checklists published by the agency, and produces submission-ready
deliverables that match the exact templates used by educators and
inspectors.
...
-   Does the user intend to host Checkpoint Varði as a single-user local
    tool, a multi-tenant shared service, or both, and how does that
    intention affect the operational plan for Stage Three?
