...
| S1-17 | Language-consistent web content for the current MVP flow | done        | #14, #19 |
...
- Keep `S1-16` parked until the export-framing and runtime-rule slices
  have settled on `main`.
